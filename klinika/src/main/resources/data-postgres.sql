...
insert into korisnici (tip, adresa, drzava, email, grad, ime, lozinka, prezime, verifikovan, aktiviran, promenjena_lozinka, broj_telefona, poslednja_promena_lozinke, pocetak_radnog_vremena, kraj_radnog_vremena, klinika_id) values('LE', 'Akšehirska 7', 'Republika Srbija', 'petarpetrovic@gmail.com', 'Beograd', 'Petar', '$2a$10$Vp90ZLx.EC./rr77SHecxeRsCeH2YdXoUBAilxpozUx9ywunntfLm', 'Petrović', true, true, true, '064-123-1210', 0, 28800000, 31800000, 1);
insert into korisnici (tip, adresa, drzava, email, grad, ime, lozinka, prezime, verifikovan, aktiviran, promenjena_lozinka, broj_telefona, poslednja_promena_lozinke, pocetak_radnog_vremena, kraj_radnog_vremena, klinika_id) values('LE', 'Topolska 18', 'Republika Srbija', 'milosmilosevic@gmail.com', 'Sombor', 'Miloš', '$2a$10$Vp90ZLx.EC./rr77SHecxeRsCeH2YdXoUBAilxpozUx9ywunntfLm', 'Milošević', true, true, true, '064-123-1211', 0, 28800000, 31800000, 1);
...
insert into specijalizovan (lekar_id, tip_pregleda_id) values (8, 1);
...
insert into pregled (lekar_id, pacijent_id, tip_pregleda_id, vreme, trajanje, otkazan,zauzet,klinika_id,sala_id,potvrdjen) values (6, 1, 1, 1589955620000, 900000, false,false,1,1,true);
insert into pregled (lekar_id, pacijent_id, tip_pregleda_id, vreme, trajanje, otkazan,zauzet,klinika_id,sala_id,potvrdjen) values (6, 2, 1, 1589955620000, 36000000, false,true,1,1,true);
insert into pregled (lekar_id, pacijent_id, tip_pregleda_id, vreme, trajanje, otkazan,zauzet,klinika_id,sala_id,potvrdjen) values (6, 2, 1, 1589955620000, 900000, false,true,1,null,false);
insert into pregled (lekar_id, pacijent_id, tip_pregleda_id, vreme, trajanje, otkazan,zauzet,klinika_id,sala_id,potvrdjen) values (6, 2, 1, 1589955620000, 900000, false,true,1,null,false);
