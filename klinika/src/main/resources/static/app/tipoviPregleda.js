Vue.component("tipoviPregleda", {
	...
	<div> 
		...
		<div class="tab-content">
			...
			<router-link :to="{ path: 'dodavanjeTipaPregleda'}" class="btn btn-primary btn-block btn-lg my-2 p-2" id="dodavanjeTipaPregleda">Dodaj novi tip pregleda</router-link>
		</div>
	</div>
	`
	,
